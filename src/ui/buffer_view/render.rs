...
impl BufferView {
    pub fn paint(
        ...
        unsafe {
            ...
            gl.scissor(
                clip_rect_in_pixels.left_px as i32,
                clip_rect_in_pixels.from_bottom_px as i32,
                clip_rect_in_pixels.width_px as i32,
                clip_rect_in_pixels.height_px as i32,
            );
            ...
            gl.uniform_4_f32(
                ...
                clip_rect_in_pixels.left_px + clip_rect_in_pixels.width_px,
            ...
            gl.uniform_4_f32(
                gl.get_uniform_location(self.draw_program, "u_draw_area")
                    .as_ref(),
                (clip_rect_in_pixels.width_px - (terminal_rect.width() * info.pixels_per_point))
                    / 2.0,
                clip_rect_in_pixels.from_bottom_px,
    ...
    pub fn update_buffer(&mut self, gl: &Arc<glow::Context>) {
        ...
        let render_buffer_size = Vec2::new(
            self.buf.get_font_dimensions().width as f32 * self.buf.get_buffer_width() as f32,
            self.buf.get_font_dimensions().height as f32 * self.buf.get_buffer_height() as f32,
        );
